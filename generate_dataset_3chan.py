...
for i, img_name in enumerate(files_path):
    create_batch(f'data/seg_train/seg_train/forest/{img_name}', f'/home/tsnow/CSC_2529_Project/ClearBoundary-main/ClearBoundary-main/dataset_noisy_forest/forest_image_{i}', in_noise = 0, noise_lvls=[0.3, 0.4, 0.5], num_per_lvl=30, img_shape=(150,150))
